...
## Usage
 ...
 3. (Optional, only required for USB-connected devices. If using a remote device, specify `-R`) Run usbmuxd/iproxy SSH forwarding over USB (Default 2222 -> 22). e.g. `iproxy 2222 22`
